...
const Matrix<Node> wages {
                ...
                {Node(5.0/9.0, 5.0/9.0),Node(8.0/9.0, 5.0/9.0),Node(5.0/9.0, 5.0/9.0),
                    Node(5.0/9.0, 8.0/9.0),Node(8.0/9.0, 8.0/9.0),Node(5.0/9.0, 8.0/9.0),
                    Node(5.0/9.0, 5.0/9.0),Node(8.0/9.0, 5.0/9.0),  Node(5.0/9.0, 5.0/9.0)},   // 9 npc wages
